...
-- AND 연산자 : 둘다 true여야 true / 하나라도 false면 false
...
where gender <> 'M'
  AND emp_no < '10050';
-- emp_no이 10050보다 작고, gender가 'M'이 아닌 조건
...
where
    ...
    emp_no NOT BETWEEN 10005 AND 499995;
-- 부정표현 (경계값 및 사이값 포함 안하고)
...
select first_name
from employees
where first_name LIKE 'Aa__d';
-- Aa로 시작하고 d로 끝나면서 5글자인 모든 데이터
